...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(2322,'rishabh', 'rishabh@gmail.com','1258','3443441238', 4700)");
        db.execSQL("insert into " + TABLE_NAME + " values(6595,'pratap kumar', 'pratap@gmail.com','8896','7645645896', 1020)");
        db.execSQL("insert into " + TABLE_NAME + " values(4438,'shiva shukla', 'shiva@gmail.com','7752','6456640038', 8540)");
        db.execSQL("insert into " + TABLE_NAME + " values(4350,'Shivani Kumari', 'shivani@gmail.com','3669','6747648962',42300)");
        db.execSQL("insert into " + TABLE_NAME + " values(2329,'priyank Joshi', 'priyank@gmail.com','9985','8855640238', 23500)");
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(1122,'virat kholi', 'virat@gmail.com','5566','9119541001', 3400)");
